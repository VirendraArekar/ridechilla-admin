...
import UserAddEdit from '../pages/user/add';
import Role from '../pages/role';
import RoleAddEdit from '../pages/role/add';
import Event from '../pages/event';
import EventAddEdit from '../pages/event/add';
...
export const routes = [
        ...
        // User route
        { path: `${process.env.PUBLIC_URL}/users/`, Component: <User /> },
        { path: `${process.env.PUBLIC_URL}/user/add-edit`, Component: <UserAddEdit /> },

        // roles
        { path: `${process.env.PUBLIC_URL}/roles/`, Component: <Role /> },
        { path: `${process.env.PUBLIC_URL}/role/add-edit`, Component: <RoleAddEdit /> },

        // events
        { path: `${process.env.PUBLIC_URL}/events/`, Component: <Event /> },
        { path: `${process.env.PUBLIC_URL}/event/add-edit`, Component: <EventAddEdit /> },

        // services
        { path: `${process.env.PUBLIC_URL}/services/`, Component: <Service /> },
        { path: `${process.env.PUBLIC_URL}/service/add-edit`, Component: <ServiceAddEdit /> },
