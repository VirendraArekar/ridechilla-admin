...
const Support = (props) => {
    ...
    return(
        <Fragment>
            ...
            <Breadcrumbs parent="Support" title="Support List" mainTitle="Support List" />
            <Container fluid={true}>
                <Row>
                <Col sm="12">
                    <Card>
                    <HeaderCard title="Select Multiple or Delete Single Data" btn="Support" btnOnclick={addSupportClick}/>
