...
import { H4, LI, UL,H6 } from '../../AbstractElements';
                    ...
                    <Row>
                      <Col xs="5">
                        ...
                        <H4 attrH4={{ className: 'total-num counter' }}>
                          <CountUp end={item.num} className="text-dark" /></H4>
                      </Col>
                      <Col xs="7">
                        <div className="text-md-end">
                          <UL attrUL={{ className: 'simple-list' }}>
                            <LI>{Profit}<span className="product-stts txt-primary ms-2">{'8989'}<i className="icon-angle-up f-12 ms-2 me-0"></i></span></LI>
                            <LI>{Loss}<span className="product-stts txt-danger ms-2">{'2560'}<i className="icon-angle-down f-12 ms-2 me-0"></i></span></LI>
                          </UL>
                        </div>
                      </Col>
                    </Row>
