...
const FontawesomeIcon = () => {
    ...
    return (
        <Fragment>
            <Breadcrumbs mainTitle='Font Awesome Icon' parent='Icons' title='Font Awesome Icon' />
            <Container fluid={true}>
                {
                    data.map((icons, index) => {
                        return (
                            <Row key={index}>
                                <FontawesomeCommon iconType={icons.icons20} title='20 Icons' parentCallback={callback} />
