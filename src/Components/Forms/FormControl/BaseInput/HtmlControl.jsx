...
import { Basicformtext, BasicHTMLInputControl, ColorPicker, Date, DateAndTime, MaximumLength, Month, Number, Password, Placeholder, SimpleInput, StaticText, Telephone, Textarea, Time, URL, Week } from '../../../../Constant';
                        ...
                        <Row>
                            <Col>
                                ...
                                <FormGroup className="row">
                                    ...
                                    <Col sm="9">
                                        <Input className="form-control digits" id="example-datetime-local-input" type="datetime-local" defaultValue="2023-01-10T18:45:00" />
                                    </Col>
                                </FormGroup>
                                <FormGroup className="row">
                                    <Label className="col-sm-3 col-form-label">{Date}</Label>
                                    <Col sm="9">
                                        <Input className="form-control digits" type="date" defaultValue="2023-01-01" />
                                    </Col>
                                </FormGroup>
                                <FormGroup className="row">
                                    <Label className="col-sm-3 col-form-label">{Month}</Label>
                                    <Col sm="9">
                                        <Input className="form-control digits" type="month" defaultValue="2023-01" />
                                    </Col>
                                </FormGroup>
                                <FormGroup className="row">
                                    <Label className="col-sm-3 col-form-label">{Week}</Label>
                                    <Col sm="9">
                                        <Input className="form-control digits" type="week" defaultValue="2023-W09" />
                                    </Col>
                                </FormGroup>
                                <FormGroup className="row">
                                ...
                                <FormGroup className="row">
                                    ...
                                    <Col sm="9">
                                        <input className="form-control form-control-color"  type="color" data-bs-original-title defaultValue="#563d7c" />
                                    </Col>
                                </FormGroup>
                                <FormGroup className="row">
