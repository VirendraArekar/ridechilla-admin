                        ...
                        <Row>
                            <Col>
                                <FormGroup>
                                    ...
                                    <Input type="select" name="select" className="form-control btn-square form-select digits" >
                                        <option>{'1'}</option>
                                        <option>{'2'}</option>
                                        <option>{'3'}</option>
                                        <option>{'4'}</option>
                        ...
                        <Row>
                            <Col>
                                <FormGroup>
                                    ...
                                    <Input type="select" name="select" className="form-control btn-square form-select digits" multiple>
                                        <option>{'1'}</option>
                                        <option>{'2'}</option>
                                        <option>{'3'}</option>
                                        <option>{'4'}</option>
