...
import { and, Choose, CityError, CustomStyles, CustomstyleText, CustomstyleText2, CustomstyleText3, CustomstyleText4, CustomstyleText5, FirstName, FirstNameError, form, invalid, LastName, LastNameError, novalidate, State, StateError, SubmitForm, TermsText, Username, UsernameError, valid, Zip, ZipError } from '../../../../Constant';
