...
export const supportData = [
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user}` }} />,
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user2}` }} />,
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user3}` }} />,
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user4}` }} />,
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user5}` }} />,
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user6}` }} />,
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user7}` }} />,
        position: 'Senior Javascript Developer',
        salary: '$433,060',
        office: 'San Francisco',
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user8}` }} />,
        position: 'Accountant',
        salary: '$162,700',
        office: 'Tokyo',
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user9}` }} />,
        position: 'Integration Specialist',
        salary: '$372,000',
        office: 'New York',
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user10}` }} />,
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user11}` }} />,
        position: 'Integration Specialist',
        salary: '$327,900',
        office: 'Tokyo',
    ...
    {
        image: <Image attrImage={{ className: 'img-40 img-fluid', src: `${user12}` }} />,
